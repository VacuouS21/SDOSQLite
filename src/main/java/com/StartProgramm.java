...
public class StartProgramm {
    ...
    private final static SDOServiceWell serviceWell= com.sdo.SDOServiceWell.getInstance(CON_STR);
    ...
    //Создание оборудования на скважинах
    ...
    //Информация об оборудовании на скважинах
    ...
    private static void getAllWell(){
        serviceWell.getAll();
    }
}
